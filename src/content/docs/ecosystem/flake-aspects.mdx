...
<Aside type="tip">
[flake-aspects](https://github.com/denful/flake-aspects) is the foundational library for reusable aspects. It has **zero dependencies** and works with or without flakes.
</Aside>
...
- **Independent users**, some people use flake-aspects [directly](https://codeberg.org/FrdrCkII/nixconf) without den, building their own Aspect oriented setups
- Mixable with existing non-aspect oriented infrastructure

## Links

<LinkButton href="https://github.com/denful/flake-aspects" icon="github" variant="secondary">Source Code</LinkButton>
<LinkButton href="https://flake-aspects.denful.dev" variant="minimal" icon="external">Documentation</LinkButton>
