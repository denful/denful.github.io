...
<Aside type="tip">
[flake-file](https://github.com/denful/flake-file) lets you define flake inputs as typed Nix module options instead of the restricted flake DSL, then regenerate `flake.nix` with a single command.
</Aside>
...
<LinkButton href="https://github.com/denful/flake-file" icon="github" variant="secondary">Source Code</LinkButton>
<LinkButton href="https://flake-file.denful.dev" variant="minimal" icon="external">Documentation</LinkButton>
